...
namespace Kachuwa.Localization
{
    public class LocaleResourceProvider : ILocaleResourceProvider
    {
        ...
        public string Get(string key)
        {
            ...
            var localeResource = _resources.FirstOrDefault(e => e.Culture == culture && e.Name == key);
        ...
        {
            string culture = GetCurrentCulture();
            var localeResources = _resources.Where(e => e.Culture == culture && e.GroupName == groupName);
