...
namespace Kachuwa.IdentityServerAdmin.Infrastructure
{
    public class TokenResponseGenerator : ITokenResponseGenerator
    {
        ...
        public TokenResponseGenerator(ISystemClock clock, ITokenService tokenService,
            IRefreshTokenService refreshTokenService, IResourceStore resources, IClientStore clients,
            ...
            TokenRequestValidationResult request)
        {
            ...
            if (request.ValidatedRequest.AuthorizationCode.IsOpenId)
            {
                ...
                {
                    client = await Clients.FindEnabledClientByIdAsync(request.ValidatedRequest.AuthorizationCode
                        .ClientId);
                }
                ...
                var resources =
                    await Resources.FindEnabledResourcesByScopeAsync(request.ValidatedRequest.AuthorizationCode
                        .RequestedScopes);
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        protected virtual async Task<TokenResponse> ProcessRefreshTokenRequestAsync(
            TokenRequestValidationResult request)
        {
        ...
        protected virtual async Task<TokenResponse> ProcessDeviceCodeRequestAsync(TokenRequestValidationResult request)
        {
            ...
            if (request.ValidatedRequest.DeviceCode.IsOpenId)
            {
                ...
                var resources =
                    await Resources.FindEnabledResourcesByScopeAsync(request.ValidatedRequest.DeviceCode
                        .AuthorizedScopes);
        ...
        /// <returns></returns>
        protected virtual async Task<TokenResponse> ProcessTokenRequestAsync(
            ...
            ValidatedTokenRequest request)
        {
            ...
            if (request.AuthorizationCode != null)
            {
                ...
                var resources =
                    await Resources.FindEnabledResourcesByScopeAsync(request.AuthorizationCode.RequestedScopes);
