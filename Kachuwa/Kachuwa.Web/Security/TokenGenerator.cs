...
namespace Kachuwa.Web.Security
{
    ...
    public class TokenGenerator : ITokenGenerator
    {
        ...
        public TokenGenerator(IWebHostEnvironment environment, ILogger logger, IAntiforgery xsrf, IOptionsSnapshot<KachuwaAppConfig> optionsSnapshot, IConfiguration configuration)
        {
