...
namespace Kachuwa.Identity.Stores
{
        ...
        where TRole : KachuwaIdentityRole<TKey, TUserRole, TRoleClaim>
    {
        ...
        public KachuwaUserStore(IConfigurationRoot configuration,
                                IIdentityUserService userService,
                                IIdentityRoleService roleService,
                               ILogger<KachuwaUserStore<TUser, TKey, TUserRole, TRoleClaim, TUserClaim, TUserLogin, TRole>> log
                              )
        {
        ...
        public async Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var result = await _userService.UserService.GetAsync(userId);
        ...
        public async Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var loginifo = await _userService.LoginService.GetAsync("Where LoginProvider=@lp and  ProviderKey=@pk",
                    new { lp = loginProvider, pk = providerKey });
        ...
        public async Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return loginifo.Select(e => new UserLoginInfo(e.LoginProvider, e.ProviderKey, e.Name)).ToList();
        ...
        public async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var userRoles = await _userService.UserRoleService.GetListAsync("Where UserId=@UserId",
                    new { UserId = user.Id });
                var roles = await _roleService.RoleService.GetListAsync("Where Id in @RoleIds",
        ...
        public async Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken)
        {
            ...
            try
            {
              ...
              var users=  await _userService.UserService.GetListAsync("Where UserId in @uids",
        ...
        public async Task<IList<TUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var userinRoles = await _userService.UserRoleService.GetListAsync("Where RoleId=@RoleId",
                   new { RoleId = role.Id });
                var users = await _userService.UserService.GetListAsync("Where Id in @UserIds",
