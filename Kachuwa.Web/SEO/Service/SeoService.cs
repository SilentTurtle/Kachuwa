...
public class SeoService : ISeoService
{
    ...
    public async Task<string> GenerateJsonLdForWebSite()
    {
        ...
        var site = new WebSite
        {
            ...
            PotentialAction = new SearchAction()
            {
                ...
                QueryInput =
                    new PropertyValueSpecification() { ValueName = "q", ValueRequired = true, MultipleValues = true },
    ...
    public async Task<string> GenerateJsonLdForPage()
    {
        ...
        else
        {
            ...
            {
                Image = _kachuwaConfig.SiteUrl + (string.IsNullOrEmpty(page.Image) == true ? storeInfo.Logo : page.Image),
                Description = page.MetaDescription,
