...
namespace Kachuwa.Web.Form
{
    ...
    public class KachuwaHtmlForm<T> : IKachuwaHtmlForm<T>
    {
        ...
        public virtual KachuwaHtmlForm<T> HideCancelButton()
        {
            Form.HideCancelButton = true;

            return this;
        }
        public virtual KachuwaHtmlForm<T> SetSubmitButtonText(string text)
        {
            Form.SubmitButtonText = text;

            return this;
        }
        public virtual KachuwaHtmlForm<T> SetCancelButtonText(string text)
        {
        ...
        public virtual KachuwaHtmlForm<T> UseTabs()
        {
            Form.UseTabs = true;
