				...
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="number" class="form-control yearofCompletion">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
				...
				'<div class="row form-row">' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="text" class="form-control hospitalname">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>From</label>' +
							'<input type="number" class="form-control experiencefrom">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							'<label>To</label>' +
							'<input type="number" class="form-control experienceto">' +
						'</div>' +
					'</div>' +
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
