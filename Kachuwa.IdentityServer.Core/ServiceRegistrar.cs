...
using Kachuwa.IdentityServer.Extension;
using Kachuwa.IdentityServer.Security;
...
namespace Kachuwa.IdentityServer.Core;
    ...
    public void Register(IServiceCollection serviceCollection, IConfiguration configuration)
    {
        ...
        var builder = serviceCollection.AddIdentity<IdentityUser, IdentityRole>(x =>
            ...
            .AddClaimsPrincipalFactory
                <Kachuwa.IdentityServer.KachuwaClaimsPrincipalFactory<IdentityUser, IdentityRole>>()
        ...
        serviceCollection.ConfigureApplicationCookie(options =>
        {
            ...
            options.DataProtectionProvider = DataProtectionProvider.Create(new DirectoryInfo(configuration["KachuwaAppConfig:DataProtectionKeyPath"]));
